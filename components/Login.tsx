  ...
  return (
    <div className="min-h-screen bg-[#050505] flex items-center justify-center relative overflow-hidden p-4 font-sans selection:bg-accent selection:text-black">
      ...
      <motion.div
        ...
        className="absolute bottom-[-20%] left-[-10%] w-[500px] h-[500px] bg-blue-500/10 rounded-full blur-[120px] pointer-events-none"
      />
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mt-8 mb-8 relative z-10">
          ...
          <p className="text-gray-400 text-sm max-w-xs mx-auto">Enter your credentials to access your workspace.</p>
        </motion.div>
        ...
        <form onSubmit={handleLogin} className="space-y-5 relative z-10">
          ...
          <motion.div variants={itemVariants} className="flex items-center justify-between text-xs relative z-10">
            ...
            <a href="#" className="text-gray-400 hover:text-accent transition-colors font-medium">Forgot password?</a>
          </motion.div>
          ...
          <motion.button
            ...
            type="submit"
            disabled={loading}
            className="w-full bg-accent text-black font-bold py-3.5 rounded-xl hover:bg-white transition-all shadow-[0_0_20px_rgba(204,255,0,0.2)] hover:shadow-[0_0_30px_rgba(204,255,0,0.4)] flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none relative z-10 overflow-hidden group/btn"
          >
        ...
        <motion.div variants={itemVariants} className="mt-8 relative z-10">
          ...
          <p className="text-center text-gray-500 text-xs mt-6">
            Don't have an account? <button onClick={() => onNavigate('signup')} className="text-accent hover:underline font-bold transition-colors">Sign Up</button>
          </p>
        </motion.div>
      </motion.div>
    </div>
